 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\BooksList> $booksLists
 * @property-read int|null $books_lists_count
...
class User extends Authenticatable implements JWTSubject
{
    ...
    public function booksLists(): HasMany
    {
        return $this->hasMany(BooksList::class);
    }
